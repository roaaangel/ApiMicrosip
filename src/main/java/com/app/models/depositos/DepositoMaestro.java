...
public class DepositoMaestro {
    ...
    private List<DepositoDetalle> depositoDetalle;
     ...
     */
    public List<DepositoDetalle> getDepositoDetalle() {
     ...
     */
    public void setDepositoDetalle(List<DepositoDetalle> depositoDetalle) {
