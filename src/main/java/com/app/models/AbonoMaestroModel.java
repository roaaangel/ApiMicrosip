 ...
 * @author angel
 */
public class AbonoMaestroModel {    
    private int id;
    ...
    private List<AbonoDetalleModel> listaAbonoDetalle;
    ...
    /**
     * @return the listaAbonoDetalle
     */
    public List<AbonoDetalleModel> getListaAbonoDetalle() {
        return listaAbonoDetalle;
    }

    /**
     * @param listaAbonoDetalle the listaAbonoDetalle to set
     */
    public void setListaAbonoDetalle(List<AbonoDetalleModel> listaAbonoDetalle) {
        this.listaAbonoDetalle = listaAbonoDetalle;
    }
}
